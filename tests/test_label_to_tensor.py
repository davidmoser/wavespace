...
def test_label_to_tensor() -> None:
    ...
    event4 = [(300, 0.2, 0.6)]
    result4 = label_to_tensor(event4, centers, duration, no_frames)
    ...
    result5 = label_to_tensor(event5, centers, duration, no_frames)
